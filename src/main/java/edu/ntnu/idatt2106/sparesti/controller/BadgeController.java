...
public class BadgeController {
   ...
   * @return ResponseEntity containing a list of achieved badges or a null response with a status
   *        code if something went wrong
   */
  @Operation(summary = "Retrieve a list with the all the badges achieved by the user.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "A list of badges was retried from the "
          + "database.",
          content = {
