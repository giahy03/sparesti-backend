...
class BadgeControllerTest {
  ...
  void getBadgesByEmailReturnsCorrectJson() throws Exception {
    ...
    when(badgeService.getAllBadgesByEmail(any(Principal.class),
            any(PageRequest.class))).thenReturn(badges);
